...
public class signups extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onError(FacebookException e) {
                Toast.makeText(signups.this,"error sign in",Toast.LENGTH_LONG).show();
            }
        });
        ...
        emailb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(u.isNetworkAvailable()) {
                    Intent signinwithemail = new Intent(signups.this, EmailSignup.class);
                    startActivity(signinwithemail);
                    finish();
                }else {
                    Toast.makeText(signups.this,"no network",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(!task.isSuccessful()){
                    hideProgressDialog();
                    Toast.makeText(signups.this,"failed",Toast.LENGTH_SHORT).show();
                }
                if (task.isSuccessful()){
                    hideProgressDialog();
                    Toast.makeText(signups.this,"success",Toast.LENGTH_SHORT).show();
                    validateUser();
                }
            }
        });
...
// Configure sign-in to request the user’s basic profile like name and email
        ...
        GoogleSignInOptions options = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("856140229385-0slbgj1uadobfq85j8pfekg28oifbv5m.apps.googleusercontent.com")
                .requestEmail()
                .build();
