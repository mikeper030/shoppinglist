...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        List<Geofence> geofenceEvent=new ArrayList<>();
        geofenceEvent=geofencingEvent.getTriggeringGeofences();
        StringBuilder sb=new StringBuilder();
        for (int i =0;i<geofenceEvent.size();i++){
          sb.append(geofenceEvent.get(i).getRequestId());
        }
        ...
        sendNotification(context, geofenceTransition,name);
    }
     ...
     */
    private void sendNotification(Context context, int transitionType,String name) {
        // Create an explicit content Intent that starts the main Activity.
        Intent notificationIntent = new Intent(context, MainActivity.class);
        String[] listtoopen=name.split(",");
        notificationIntent.putExtra("name",listtoopen[0]);
        ...
        builder.setContentText(context.getString(R.string.launch));
